...
humanoid-profile-editor-loadouts = Показать экипировку
...
humanoid-profile-editor-loadouts-whitelist = Белый лист:
humanoid-profile-editor-loadouts-blacklist = Черный лист:
